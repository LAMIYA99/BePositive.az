  ...
  return (
    <section className="relative w-full h-[600px] sm:h-[650px] md:h-[700px] lg:h-[750px] overflow-hidden flex justify-center items-center">
      <Image
        ...
        priority
        placeholder="blur"
        blurDataURL="data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxMCIgaGVpZ2h0PSIxMCIgdmlld0JveD0iMCAwIDEwIDEwIj48cmVjdCB3aWR0aD0iMTAiIGhlaWdodD0iMTAiIGZpbGw9IiNlMGUyZTgiLz48L3N2Zz4="
        sizes="100vw"
      ...
      <div className="relative flex flex-col items-center gap-4 sm:gap-6 md:gap-8 lg:gap-10 px-4 text-center">
        <h1
          data-aos="zoom-in-up"
          className="text-white text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] font-bold leading-10 sm:leading-12 md:leading-14 lg:leading-[66px] font-inter"
        >
