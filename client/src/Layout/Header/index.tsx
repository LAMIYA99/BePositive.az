  ...
  return (
    <header className="container mx-auto flex items-center justify-between py-6 md:py-10 relative px-6">
      ...
      <div className="relative hidden md:block">
        ...
        >
          <li className="text-[22px] font-inter font-medium">
            {currentLang.code}
          </li>
          <li>
            <img
          ...
          >
            ...
            >
              ...
              <div className="px-4 py-3 flex items-start flex-col gap-[22px]">
                <h2 className="text-[#4A5565] text-[16px]">Select Language</h2>
                <div className="flex items-center gap-3">
                  <button className="flex items-center justify-center w-[142px] px-4 py-3 gap-2 border border-[#E5E7EB] hover:bg-[#155DFC] hover:text-white rounded-2xl">
                    <img src="/Aze.png" className="w-8 h-8" /> Azərbaycanca
                  </button>
                  <button className="flex items-center justify-center w-[142px] px-4 py-3 gap-2 border border-[#E5E7EB] hover:bg-[#155DFC] hover:text-white rounded-2xl">
                    <img src="/en.png" className="w-8 h-8" /> English
                  </button>
                </div>
              </div>
            </motion.div>
